...
public:
    ...
    STDMETHODIMP get_Settings(bool* pbActivated, int* piFrameOutput, int* piNumIterations, int* piMaxOffsetDivider, int* piIntActiveState, double* pdSourceFPS, int* piNumSteps) override;
    STDMETHODIMP put_Settings(bool bActivated, int iFrameOutput, int iNumIterations, int iMaxOffsetDivider) override;
