...
__kernel void copyFrameKernel(__global const unsigned char* sourceFrame, __global unsigned char* outputFrame,
    ...
    unsigned char value = sourceFrame[cz * dimY * inputStride + cy * inputStride + cx];
