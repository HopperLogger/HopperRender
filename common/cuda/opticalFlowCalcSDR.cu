...
void OpticalFlowCalcSDR::warpFramesForOutput(float fScalar, const bool bOutput12) {
	...
	// Frame 1 to Frame 2
	if (bOutput12) {
		warpFrameKernelForOutputSDR << <m_grid16x16x1, m_threads16x16x2 >> > (m_bBisNewest ? m_frame1.arrayPtrGPU : m_frame2.arrayPtrGPU, m_blurredOffsetArray12.arrayPtrGPU,
		...
		artifactRemovalKernelForOutputSDR << <m_grid8x8x1, m_threads8x8x2 >> > (m_bBisNewest ? m_frame1.arrayPtrGPU : m_frame2.arrayPtrGPU, m_hitCount12.arrayPtrGPU,
																	m_outputFrame.arrayPtrGPU, m_iDimY, m_iDimX, m_iScaledDimX, m_iChannelIdxOffset, m_iScaledChannelIdxOffset);
	// Frame 2 to Frame 1
	} else {
		warpFrameKernelForOutputSDR << <m_grid16x16x1, m_threads16x16x2 >> > (m_bBisNewest ? m_frame2.arrayPtrGPU : m_frame1.arrayPtrGPU, m_blurredOffsetArray21.arrayPtrGPU,
																m_hitCount21.arrayPtrGPU, m_ones.arrayPtrGPU, 
																m_outputFrame.arrayPtrGPU, frameScalar21, m_iLowDimY, m_iLowDimX,
																m_iDimY, m_iDimX, m_fResolutionDivider, m_iLayerIdxOffset, m_iScaledDimX, m_iChannelIdxOffset, m_iScaledChannelIdxOffset);
		artifactRemovalKernelForOutputSDR << <m_grid8x8x1, m_threads8x8x2 >> > (m_bBisNewest ? m_frame2.arrayPtrGPU : m_frame1.arrayPtrGPU, m_hitCount21.arrayPtrGPU,
																	m_outputFrame.arrayPtrGPU, m_iDimY, m_iDimX, m_iScaledDimX, m_iChannelIdxOffset, m_iScaledChannelIdxOffset);
	}
}
...
void OpticalFlowCalcSDR::warpFramesForBlending(float fScalar) {
	...
	// Frame 1 to Frame 2
	warpFrameKernelForBlendingSDR << <m_grid16x16x1, m_threads16x16x2, 0, warpStream1 >> > (m_bBisNewest ? m_frame1.arrayPtrGPU : m_frame2.arrayPtrGPU, m_blurredOffsetArray12.arrayPtrGPU,
														        m_hitCount12.arrayPtrGPU, m_ones.arrayPtrGPU, 
	...
	// Frame 2 to Frame 1
	warpFrameKernelForBlendingSDR << <m_grid16x16x1, m_threads16x16x2, 0, warpStream2 >> > (m_bBisNewest ? m_frame2.arrayPtrGPU : m_frame1.arrayPtrGPU, m_blurredOffsetArray21.arrayPtrGPU,
																m_hitCount21.arrayPtrGPU, m_ones.arrayPtrGPU, 
